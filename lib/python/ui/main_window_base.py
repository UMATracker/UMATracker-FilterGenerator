...
class Ui_MainWindowBase(object):
    def setupUi(self, MainWindowBase):
        ...
        self.menuSettings.addAction(self.actionResize)
    ...
    def retranslateUi(self, MainWindowBase):
        ...
        self.actionSaveFilterData.setText(_translate("MainWindowBase", "Save Filter"))
        self.actionOpenFilterData.setText(_translate("MainWindowBase", "Open Filter"))
        self.actionCreateBackground.setText(_translate("MainWindowBase", "Create Background"))
